"""
Repeat the tensorflow exercise that was shown with Keras with Python Gekko but change 
the activation function to a cosine to better extrapolate outside of the training 
region. The training data are 20 equally spaced points for x between 0 and 2π
with outputs generated from the sine function y = sin(x). """
